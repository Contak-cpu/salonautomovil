...
export const USED_CARS: UsedCar[] = [
  ...
  },
  {
    ...
    color: 'Gris',
    images: ['/images/used-cars/clio1.png', '/images/used-cars/clio2.png', '/images/used-cars/clio3.png'],
    features: ['Aire Acondicionado', 'Dirección Asistida', 'ABS', 'Airbags'],
    location: 'Córdoba Capital',
    isWarranty: true,
    isInspected: true,
    isFinancing: true,
    description: 'Sedán 3 puertas, impecable, exterior gris.',
    seller: {
      name: 'Salón del Automóvil',
      phone: '+54 9 3541 579-927',
      whatsapp: '5493541579927'
  ...
  },
  {
    ...
    engine: '1.6L 4 Cilindros',
    color: 'Azul',
    images: ['/images/used-cars/kangoo1.png', '/images/used-cars/kangoo2.png', '/images/used-cars/kangoo3.png'],
    features: ['Aire Acondicionado', 'Dirección Asistida', 'ABS', 'Airbags', 'GNC 5° Generación', '2 Tubos'],
    location: 'Córdoba Capital',
    isWarranty: true,
    isInspected: true,
    isFinancing: true,
  ...
  },
  {
    ...
    fuelType: 'Nafta',
    transmission: 'Manual',
    engine: '1.0L MPI 3 Cilindros',
    color: 'Rojo',
    images: ['/images/used-cars/up1.png', '/images/used-cars/up2.png', '/images/used-cars/up3.png'],
    features: ['Aire Acondicionado', 'Dirección Asistida', 'ABS', 'Airbags', 'Bluetooth'],
    location: 'Córdoba Capital',
    isWarranty: true,
    isInspected: true,
    isFinancing: true,
    description: 'Sedán 3 puertas, caja manual, exterior rojo.',
    seller: {
      name: 'Salón del Automóvil',
      phone: '+54 9 3541 579-927',
      whatsapp: '5493541579927'
  ...
  },
  {
    ...
    engine: '2.0L 4 Cilindros',
    color: 'Gris Oscuro',
    images: ['/images/used-cars/ventogli1.png', '/images/used-cars/ventogli2.png', '/images/used-cars/ventogli3.png'],
    features: ['Aire Acondicionado', 'Dirección Asistida', 'ABS', 'ESP', 'Airbags', 'Turbo', 'Suspensión Deportiva'],
    location: 'Córdoba Capital',
    isWarranty: true,
    isInspected: true,
    isFinancing: true,
...
export const LOCATIONS = ['Córdoba Capital'];
