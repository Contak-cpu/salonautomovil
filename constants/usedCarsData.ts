...
export const USED_CARS: UsedCar[] = [
  ...
  },
  {
    ...
    color: 'Rojo',
    images: ['/images/used-cars/maruti2.png', '/images/used-cars/maruti1.png', '/images/used-cars/maruti3.png'],
  ...
  },
  {
    ...
    make: 'Mercedes-Benz',
    model: 'C230',
    version: 'Sportcoupe V6 Automático',
    year: 2006,
    mileage: 0,
    price: 19900,
    priceCurrency: 'USD',
    ...
    engine: 'V6 2.5L',
    color: 'Negro',
    images: ['/images/used-cars/MB-C230/mercedes230.png', '/images/used-cars/MB-C230/mercedes2302.png', '/images/used-cars/MB-C230/mercedes2303.png'],
    features: ['Aire Acondicionado', 'Dirección Asistida', 'ABS', 'ESP', 'Airbags', 'Tapizado de Cuero', 'Asientos de Cuero'],
    location: 'Villa Carlos Paz, Córdoba',
    isWarranty: true,
    isInspected: true,
    isFinancing: true,
    description: 'C230 Sportcoupe V6 automático con tapizado de cuero, año 2006, impecable, color negro.',
    seller: {
      name: 'Salón del Automóvil',
      phone: '+54 9 3541 579-927',
      whatsapp: '5493541579927'
