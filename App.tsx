  ...
  return (
    <div className="min-h-screen gradient-bg text-white font-sans">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col space-y-3">
        {/* WhatsApp Button */}
        <a
          href="https://api.whatsapp.com/send?phone=5493541579927&text=Hola%2C%20estoy%20interesado%20en%20un%20veh%C3%ADculo%20de%20Sal%C3%B3n%20del%20Autom%C3%B3vil."
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Contáctanos por WhatsApp"
          className="h-14 w-14 rounded-full shadow-lg animate-pulse-whatsapp"
        >
