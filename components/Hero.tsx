    ...
    <section className="h-[calc(100vh-80px)] flex flex-col md:flex-row">
      ...
      >
        <div className="absolute inset-0 bg-black/60 group-hover:bg-black/50 transition-colors duration-300 flex flex-col justify-center items-center text-center p-4">
          <div className="transform transition-transform duration-300 group-hover:scale-105">
            <h2 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg">AUTOS 0KM</h2>
            <p className="mt-4 text-lg text-gray-light max-w-md drop-shadow-md">La última tecnología y el confort que buscás, directo de fábrica.</p>
      ...
      >
        <div className="absolute inset-0 bg-black/70 group-hover:bg-black/60 transition-colors duration-300 flex flex-col justify-center items-center text-center p-4">
          <div className="transform transition-transform duration-300 group-hover:scale-105">
            <h2 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg">AUTOS USADOS</h2>
            <p className="mt-4 text-lg text-gray-light max-w-md drop-shadow-md">Selección premium de vehículos usados con garantía y confianza.</p>
