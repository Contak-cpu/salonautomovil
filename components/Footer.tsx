            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    <div className="flex justify-center items-center">
                        <div className="mb-6 ml-8 md:ml-4">
                            <img 
                    ...
                    <div>
                        <h4 className="text-xl font-bold text-white mb-6 flex items-center gap-2 justify-center md:justify-start">
                ...
                <div className="text-center text-sm border-t border-gray-light/20 pt-8">
                    <p className="text-white text-center">Copyright 2025 - GRUPO SARKIS S.A.S. - CUIT 30-71889993-8</p>
                    <p className="text-white text-center">&copy; Salón del Automóvil. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    );
